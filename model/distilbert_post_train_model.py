...
class DistilBERTPostTrain(nn.Module):
    def __init__(self,
        ...
        self.distilbert = DistilBertModel.from_pretrained(path, config=config, state_dict=state_dict)
    ...
    def forward(
        ...
        if labels is not None and next_sentence_label is not None:
            ...
            masked_lm_loss = loss_fct(prediction_scores.view(-1, self.distilbert.config.vocab_size), labels.view(-1))
